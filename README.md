...
Bayesian Optimization of Antibodies Informed by a Generative Model of Evolving Sequences. [paper](https://openreview.net/pdf?id=E48QvQppIN), [code](https://github.com/AlanNawzadAmin/CloneBO)  
&nbsp;&nbsp;&nbsp;&nbsp;**Amin A N**, Gruver N\*, Kuang Y\*, Li L\*, Elliott H, McCarter C, Raghu A, Greenside P, Wilson A G. (*Equal contribution).  *Preprint soon, presenting at AIDrugX at Neurips*, 2024. 
